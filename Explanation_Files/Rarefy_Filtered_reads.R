path <- "/Users/jvb740/MarieCurie_Work/DanFunDProject/Pretest/Pretest_Dada_Analysis/Dada_FilteredFastqs"
pathsave <- "/Users/jvb740/MarieCurie_Work/DanFunDProject/Pretest/Pretest_Dada_Analysis_FilterRarefied/Dada_FilteredReads_rarefied"


full_files <- dir(path)
#no_reads <- vector(mode = "numeric", length = length(full_files))
min_no_reads <- 14504 # min as determined from ReadSummary
