...
```{r, echo = FALSE, message=FALSE}
Phyla <- dplyr::summarise(group_by(df_ab_prev, Phylum), SVs = n(), PC_SV = round(100*n()/ntaxa(ps),1), PC_total_pre = round(100*sum(prevalence)/sum(df_ab_prev$prevalence), 1),
...
- NB: <https://f1000research.com/articles/5-1492/v1> did it just with log transformed counts, here with relative abundances
