...
## Abundance and prevalence distributions of the remaining `r ntaxa(ps)` amplicon sequence variants (ASVs) in `r nsamples(ps)` samples
...
## Prevalence and abundance of the taxa after tax_glom in relation to the chosen prevalence that you later use for filtering
