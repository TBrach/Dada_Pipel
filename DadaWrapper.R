...
filtFs <- file.path("/Users/jvb740/MarieCurie_Work/MouseProject/ResultsAndProtocols/ManiAging_Results/16S_Sequencing/2017-07-13_DK_age_ManiAging/Dada2_Analysis_filt_rare_40000/Dada_FilteredReads_rarefied", basename(filtFs))
filtRs <- file.path("/Users/jvb740/MarieCurie_Work/MouseProject/ResultsAndProtocols/ManiAging_Results/16S_Sequencing/2017-07-13_DK_age_ManiAging/Dada2_Analysis_filt_rare_40000/Dada_FilteredReads_rarefied", basename(filtRs))
names(filtFs) <- namesF
names(filtRs) <- namesR
...
Dada2_wrap(path = "/Users/jvb740/MarieCurie_Work/MouseProject/ResultsAndProtocols/ManiAging_Results/16S_Sequencing/2017-07-13_DK_age_ManiAging/Clean",
           F_pattern = "1.fq.gz", 
           R_pattern = "2.fq.gz",
           path2 = "/Users/jvb740/MarieCurie_Work/MouseProject/ResultsAndProtocols/ManiAging_Results/16S_Sequencing/2017-07-13_DK_age_ManiAging/Dada2_Analysis_filt_rare_40000", #"/emc/cbmr/data/MICROBIOME/raw/mouse/stool/Pooled2"
